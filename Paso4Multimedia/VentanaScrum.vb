Public Class VentanaScrum
    ...
    Private Sub AbrirVentanaVideo()
        Dim vv As New VentanaVideo(VentanaInicio.VENTANA_SCRUM)
        vv.Show()
        Hide()
    End Sub

    Private Sub AbrirVentanaAudio()
        Dim va As New VentanaAudio(VentanaInicio.VENTANA_SCRUM)
        va.Show()
        Hide()
    End Sub

    Private Sub AbrirVentanaTexto()
        Dim vt As New VentanaTexto(VentanaInicio.VENTANA_SCRUM)
        vt.Show()
        Hide()
    End Sub

    Private Sub AbrirVentanaImagen()
        Dim vi As New VentanaImagen(VentanaInicio.VENTANA_SCRUM)
        vi.Show()
        Hide()
    End Sub
    'Video
